        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item ">
            <div className="carousel-caption  d-md-block">
              <div className="row">
                <div className="col-6">
                  <span className='wow animate__animated animate__fadeInUp animate-delay'>Khám phá các khoá học của CyberSoft</span>
                  <h2 className='wow animate__animated animate__fadeInUp animate-delay'>CYBERSOFT - ĐÀO TẠO LẬP TRÌNH THEO LỘ TRÌNH DỰ ÁN</h2>
          ...
          <div className="carousel-item ">
            <div className="carousel-caption  d-md-block">
              <div className="row">
                <div className="col-6">
                  <span className='wow animate__animated animate__fadeInUp animate-delay'>Cybersoft là ai ?</span>
                  <h2 className='wow animate__animated animate__fadeInUp animate-delay'>CHÚNG TÔI TIN VÀO TIỀM NĂNG CỦA CON NGƯỜI</h2>
                  <p className='wow animate__animated animate__fadeInUp animate-delay '> Bất kể ai cũng có thể là một lập trình, tham gia trong đội ngữ Tech, bất kể tuổi tác, nền tảng, giới tính hoặc tình trạng tài chính. Chúng tôi không bỏ qua những người mới bắt đầu hoặc chưa có kinh nghiệm theo đuổi đam mê lập trình. Thay vào đó, chúng tôi chào đón học viên của tất cả các cấp độ kinh nghiệm. Lộ trình học tập của CyberSoft may đo cho từng đối tượng để học xong và đi làm ngay.</p>
                  <NavLink to='/' className="btn btn--common btn-primary wow animate__animated animate__fadeInUp animate-delay" data-animation="fadeInUp" data-delay="1s" tabIndex={-1} >
                    Xem chi tiết
                    <i className="fa-solid fa-arrow-right"></i>
                  </NavLink>
